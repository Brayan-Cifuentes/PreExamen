...
public class Factura extends javax.swing.JInternalFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            if (rs.next()) {
                txt_idfactura.setText(rs.getString("ID_Factura"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            pst.setString(1, txt_idfactura.getText().trim());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Connection cn = DriverManager.getConnection(BD, Usuario, Clave);
            PreparedStatement pst = cn.prepareStatement("update Factura set ID_Factura = ?, ID_Cliente=?, Fecha=?, Total=? where ID_Factura = " + ID);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            Connection cn = DriverManager.getConnection(BD, Usuario, Clave);
            PreparedStatement pst = cn.prepareStatement("delete from Factura where ID_Factura = ?");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            Connection cn = DriverManager.getConnection(BD, Usuario, Clave);
            PreparedStatement pst = cn.prepareStatement("select Subtotal from Detalle_Factura where ID_Factura=?");
            pst.setString(1, txt_idfactura.getText().trim());

            ResultSet rs = pst.executeQuery();

            float contador = 0; float convertir;
            for (int i = 0; i < 10; i++) {
                if (rs.next()) {
                    prueba.setText(rs.getString("Subtotal")); // va a poner en el label el resultado que manda a traer 
                    convertir=Float.parseFloat(prueba.getText());// convierte a float cada resultado
                    // lo suma y va haciendo el contador, 
                    contador+=convertir;
                }
            }
            prueba.setText(""); // para dejar en blanco el label asi solo 
            txt_total.setText(Float.toString(contador));
